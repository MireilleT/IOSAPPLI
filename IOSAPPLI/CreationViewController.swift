...
class CreationViewController: UIViewController {
    ...
    @IBAction func enregBoutton(_ sender: AnyObject) {
        ...
        if (nom.isEmpty || prenom.isEmpty || datenai.isEmpty || email.isEmpty || mdp.isEmpty || (repmdp.isEmpty))
        ...
        if ( (nom != "" || prenom != "" || datenai != "" || email != "" || mdp != "" || repmdp != "") && (mdp != repmdp))
        ...
        if (nom != "" || prenom != "" || datenai != "" || email != "" || mdp != "" || repmdp != "" )
        {
    ...
    @IBAction func connectionBoutton(_ sender: AnyObject) {
